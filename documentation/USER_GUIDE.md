...
**Location**: Default tab when you log in (💬 Therapy Chat)
...
- ✅ Your pet gets rewarded (+13 happiness, +8 energy, 5 coins, 15 XP)
- 📊 Your mood is tracked for insights
- 🧠 AI memory updates with your current state
- 🔔 If your mood is very low, your clinician may be notified
...
- ✅ Pet gets rewarded (+13 happiness, +8 energy, 5 coins, 15 XP)
- 🧠 AI learns what brings you joy
- 📈 Track your gratitude journey over time

---

## CBT Tools

**Location**: 🧠 CBT Tools tab
...
- ✅ Pet gets **bonus rewards** (+15 coins, +20 XP for CBT work)
- 🧠 AI learns your thinking patterns
- 💪 You build healthier thought habits
...
**Location**: 📋 Clinical Assessments tab
...
- 📊 Your score and severity level are calculated
- 🔔 **You get notified**: "PHQ-9 completed. Score: X (Severity). Next available in 14 days."
- 🔔 **Your clinician gets notified**: "Patient [you] completed PHQ-9. Score: X (Severity)."
- ✅ Pet gets **big rewards** (+20 coins, +30 XP for completing assessment)
- 🧠 AI updates with your current severity level
...
- **Hunger** 🍽️ - Keeps pet fed and healthy
- **Happiness** 😊 - Shows emotional wellbeing
- **Energy** ⚡ - Pet's vitality and alertness
...
**Coins** 🪙 - Buy food and items in the shop
- Mood/Gratitude: 5 coins
- CBT: 15 coins
- Assessments: 20 coins
- Walking: 15-25 coins

**XP** ⭐ - Pet evolution progress
...
**Walking Rewards:**
- 🪙 15-25 coins (random)
- 🎁 Random gift: 🌸 flower, 🍃 leaf, 🪨 pebble, 🦋 butterfly, or 🌟 gem
- 💬 Affirmation message: "You're taking great care of yourself!"
- +15 happiness, +10 energy

### The Shop

**Available Items:**
- 🍎 Apple (10 coins) - Restores 20 hunger
- 🥕 Carrot (15 coins) - Restores 25 hunger
- 🍔 Burger (20 coins) - Restores 30 hunger
...
Click the ❤️ to show support (you can unlike by clicking again).
...
4. ✅ **Check "Highlight as important"** for key observations
5. **Click "Save Note"**

### What Happens Next

- 🧠 **AI memory updates immediately** - The AI will reference your notes in future conversations with the patient
- 💾 Note is saved with timestamp
- 🔒 Only you can see your notes (patient cannot)
...
- Patient logs mood → AI knows current emotional state
- Patient does assessment → AI knows severity level
- **You add therapy note → AI knows your clinical observations**
- Patient does CBT → AI knows cognitive patterns
- Patient writes gratitude → AI knows sources of joy

### Working With The AI

**The AI is your assistant, not replacement:**
- ✅ Provides 24/7 support between sessions
- ✅ References YOUR clinical notes in conversations
- ✅ Applies evidence-based techniques (CBT, DBT, etc.)
- ✅ Detects crisis language and alerts you
- ❌ Does NOT diagnose
